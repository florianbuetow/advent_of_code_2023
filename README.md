...
__Note:__ The input data for each challenge differ by user. If you are using this project as a template for your own solutions, you will need to log in to the [Advent of Code](https://adventofcode.com) website to get your personal puzzle input and replace the existing data in the `data` folder with it.
